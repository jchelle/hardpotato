...
models_available = ['chi1205b', 'chi1242b', 'chi601e', 'chi760e', 'emstatpico', 'chi620e', 'chi650e']
...
class Info:
    ...
    def __init__(self, model):
        ...
        elif self.model == 'chi620e':
            self.info = chi620e.Info()
